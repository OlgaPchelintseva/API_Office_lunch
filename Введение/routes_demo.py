...
@app.put('/items/{item_id}')  #полное обновление
async def update_item(itrm_id: int, name: str):
    return {'id': itrm_id, 'name': name, 'updated': True}

@app.delete('/items/{item_id}')
async def delete_item(item_id: int):
    return {'id': item_id, 'deleted': True}

@app.patch('/items/{item_id}') # частичное обновление 
