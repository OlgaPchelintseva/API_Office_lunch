...
class UserResponse(BaseModel):
    ...
    model_config = ConfigDict(from_attributes = True) # разрешаем работу с URL объектами

class SessionCreate(BaseModel):
    creator_id: int = Field(..., description = 'ID пользователя, оганизующего сбор')
...
class OrderItemCreate(BaseModel):
    ...
    menu_item_id: int = Field(..., descriotion = 'ID блюда из меню')
